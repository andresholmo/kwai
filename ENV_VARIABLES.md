...
- `KWAI_AGENT_ID` - ID do agente (obrigatório para buscar contas) - Exemplo: `76407091`
...
O `KWAI_AGENT_ID` é obrigatório para buscar contas através da API `crmAccountQueryByAgentOrCorp`. 
